...
<head>
    ...
    <title>Edit Persyaratan Berkas</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center px-4">
    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-lg">
        ...
        <h1 class="text-2xl font-bold mb-4 text-gray-800 text-center">Edit Persyaratan Berkas</h1>

        <form action="{{ route('persyaratan_berkas.update', $persyaratan_berkas->id) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            <div>
                ...
                <input
                    ...
                    name="nama_berkas"
                    id="nama_berkas"
                    value="{{ old('nama_berkas', $persyaratan_berkas->nama_berkas) }}"
