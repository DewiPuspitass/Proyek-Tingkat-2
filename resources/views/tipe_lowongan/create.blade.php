...
<head>
    ...
    <title>Tambah Tipe Lowongan</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center px-4">
    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-lg">
        ...
        <h1 class="text-2xl font-bold mb-4 text-gray-800 text-center">Tambah Tipe Lowongan</h1>

        <form action="{{ Route('tipe_lowongan.store') }}" method="POST" class="space-y-4">
            @csrf
            <div>
