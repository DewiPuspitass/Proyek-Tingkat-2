...
<html>
  <body style="margin:0; padding:0; font-family:Arial, sans-serif; text-align: justify; text-justify: inter-word;">
    <p>Hallo <b>{{ $name }}</b>,</p>
    <p>Kami ingin memberitahukan bahwa saat ini telah dibuka lowongan kerja baru di <b>{{ $nama_perusahaan }}</b>! Ini adalah kesempatan emas untuk kamu yang sedang mencari tantangan baru dan ingin berkembang.</p>
