    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <x-text-input id="nis" class="mt-1 block w-full bg-white bg-opacity-20 border border-gray-300 text-white 
                    placeholder-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 rounded-md shadow-sm"
                    type="text" name="nis" :value="old('nis')" required autofocus autocomplete="name" placeholder="Masukkan NIS" />
            ...
            <div>
                ...
                <x-text-input id="name" class="mt-1 block w-full bg-white bg-opacity-20 border border-gray-300 text-white 
                    placeholder-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 rounded-md shadow-sm"
                    type="text" name="name" :value="old('name')" required placeholder="Masukkan Nama" />
            ...
            <div>
                ...
                <select id="jurusan" name="jurusan" required
                    class="block mt-1 w-full bg-white bg-opacity-20 border border-gray-300 text-white 
                    placeholder-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 rounded-md shadow-sm">
                    <option value="" disabled selected>Pilih Jurusan</option>
                    @foreach ($jurusanList as $jurusan)
                        <option value="{{ $jurusan->id }}" class="text-black" {{ old('jurusan') == $jurusan->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <select id="tahun_angkatan" name="tahun_angkatan" required
                    class="block mt-1 w-full bg-white bg-opacity-20 border border-gray-300 text-white 
                    placeholder-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 rounded-md shadow-sm">
            ...
            <div>
                ...
                <x-text-input id="no_telp" class="mt-1 block w-full bg-white bg-opacity-20 border border-gray-300 text-white 
                    placeholder-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 rounded-md shadow-sm"
                    type="text" name="no_telp" :value="old('no_telp')" required placeholder="Masukkan No Telp" />
            ...
            <div>
                ...
                <x-text-input id="email" class="mt-1 block w-full bg-white bg-opacity-20 border border-gray-300 text-white 
                    placeholder-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 rounded-md shadow-sm"
        ...
        <div class="mt-6">
            ...
            <x-text-input id="password" class="mt-1 block w-full bg-white bg-opacity-20 border border-gray-300 text-white 
                placeholder-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 rounded-md shadow-sm"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation" class="mt-1 block w-full bg-white bg-opacity-20 border border-gray-300 text-white 
                placeholder-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 rounded-md shadow-sm"
